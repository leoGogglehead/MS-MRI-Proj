%%
% This script performs evaluates logistic regression on prediction made
...
for tR = 1 : length(topRange)
    for subjInd = 1 : length(subjwo)
        ...
        clearvars -except subjwo segList subjw subjMRIwo topRange tR YY
    end
    ...
    for subjInd = 1 : length(subjw)
        ...
        % choose the top 94 - 95% top voxels
        [voxelSortT2,I2] = sort(T2img(:));
        ...
        clearvars -except subjwo segList subjw subjMRIw subjMRIwo chosenInd2 topRange tR YY
    end
count = 0;
    ...
    for i = 1 : 10
        ...
        for j = 1 : 5
            ...
            trainW(count*length(col1) +1 : (count+1)*length(col2), 1: 4) = [col1 col2 col3 subjWData(:,3)];
            count = count+1;
        end
        ...
        for k = 1 : 5
            ...
            trainWO(count*length(col1) +1 : (count+1)*length(col2), 1: 4) = [col1 col2 col3 subjWOData(:,3)];
            count = count+1;
        end
